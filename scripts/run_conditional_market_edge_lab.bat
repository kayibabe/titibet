...
python backend\scripts\conditional_market_edge_lab.py --from 2026-01-01 --to 2026-06-30 --validation-from 2026-05-01 --validation-to 2026-06-30 --output conditional_market_edge_lab.json
if errorlevel 1 (
    echo.
